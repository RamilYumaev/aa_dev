...
class FlashMessages
{
    ...
    public static function get()
    {
        ...
        return [
            ...
            'sumMushMark'=> "Сумма баллов больше 100",
            'activeTest'=> "Вы не можете менять баллы, твк как тест запущен",
            'activeTestActionDelete'=> "Вы не можете удалить вопрос или группу вопросов, твк как тест запущен",

...
class VolunteeringForm extends Model
{
    public $clothes_type, $clothes_size, $link_vk, $job_entrant_id, $faculty_id,
        $experience, $note, $conditions_of_work, $form_edu, $course_edu, $finance_edu, $number_edu, $desire_work, $is_reception;
    public $post;
    ...
    public function rules()
    {
        return [
            ...
            [['form_edu', 'course_edu', 'finance_edu', 'clothes_type', 'conditions_of_work', 'clothes_size', 'job_entrant_id', 'faculty_id',], 'integer'],

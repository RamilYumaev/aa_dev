...
{
    public $faculty_id, $is_vi, $note, $type, $form_edu, $special_right, $finance_edu, $datetime_start, $datetime_end, $edu_level;
    ...
    public function rules()
    {
        return [
            ...
            [['note'], 'string' ],
            [['datetime_start', 'datetime_end'], 'date', 'format' => 'yyyy-M-d H:m'],
            ['is_vi','boolean'],
        ];
    }

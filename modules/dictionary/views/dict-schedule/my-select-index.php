                ...
                'columns' => [
                    ...
                    [
                        'value' => function(DictSchedule $model) use ($jobEntrant) {
                            return $model->isEntrant($jobEntrant->id)  || $model->isCountEnd() ? "" :
                                Html::a('Взять график', ['dict-schedule/select-schedule', 'id' => $model->id], ['class' => 'btn btn-primary', 'data-confirm' => ['Вы уверены, что хотите взять график?']]);
                        },
                        'format' =>  'raw'
                    ],
                ]

...
<div>
    <div class="box">
        <div class="box-header">
            ...
            <?= Html::a('Провести конкурс (Финал)', ['final-handle'], ['class'=>'btn btn-danger', 'data-confirm'=> "Вы уверенны, что хотичте это сделать?"]) ?>
            <?= Html::a('Обнулить конкурс', ['clear'], ['class'=>'btn btn-info', 'data-confirm'=> "Вы уверенны, что хотичте это сделать?"]) ?>

...
class ItemsForSignatureApp
{
    ...
    public static function getItemsText()
    {
        return [
            ...
            7 => "С датой завершения приёма оригинала документа об образовании (при поступлении на места, финансируемые 
            из федерального бюджета) и заявления о согласии на зачисление ознакомлен(а)",
            8 => "Я предупрежден(а) о том, что без предоставления в Приёмную комиссию оригинала документа об образовании 
            (при поступлении на места, финансируемые из федерального бюджета) и заявления о согласии на зачисление 
            на данную образовательную программу вопрос о моем зачислении рассматриваться не будет",
            9 => "Я предупрежден(а) о том, что заявление о согласии на зачисление на одну образовательную программу 
            в МПГУ (на места, финансируемые из федерального бюджета) может быть подано не более двух раз",

...
<table width="100%">
    ...
    <tr>
        <td></td>
        <td colspan="3" class="v-align-top text-center fs-7"><i>(фамилия, имя, отчество, дата рождения поступающего)</i></td>
        <td></td>
    </tr>
    <tr>
...
<?php if(!\Yii::$app->user->identity->eighteenYearsOld()):?>
    <table class="mt-30" width="100%">
        ...
        <tr>
            <td></td>
            <td class="text-center fs-7 h-30"><i>(фамилия, имя, отчество, дата рождения законного представителя)</i></td>
        </tr>
    </table>
<table width="100%">
    <tr>
...
<table width="100%">
    ...
    <tr><td colspan="6" class="bb h-30"></td></tr>
</table>

<table width="100%">
    <tr><td class="h-30" width="32%">зарегистрированный(ая) по адресу:</td><td width="68%" class="bb"></td></tr>
    <tr><td colspan="2" class="bb h-30"></td></tr>
</table>

<table width="100%">
    <tr><td width="32%" class="h-30">являясь законным представителем</td><td class="bb"></td></tr>
</table>
<table width="100%">
    <tr>
...
<table width="100%">
    <tr><td class="h-30" width="32%">зарегистрированного(ой) по адресу:</td><td width="68%" class="bb"></td></tr>
    <tr><td colspan="2" class="bb h-30"></td></tr>
</table>

<table width="100%">
    <tr><td width="14%" class="h-30">на основании</td><td class="bb"></td></tr>
    <tr><td></td>
        <td class="fs-7 text-center"><i>(документ, подтверждающий, что Субъект является законным представителем поступающего)</i>
        </td></tr>
</table>
<?php endif;?>
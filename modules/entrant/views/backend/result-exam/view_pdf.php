...
<h4>Лицо, сформировавшее справку:</h4>
<div class="mt-10">
    <table>
        <tr>
            <td class="bb w-200"><strong><?= mb_strtolower($jobEntrant->postName) ?></strong></td>
            <td></td>
            <td class="bb w-200"></td>
            <td></td>
            <td class="bb w-200"><strong><?= $jobEntrant->profileUser->fio ?></strong></td>
            <td></td>
            <td></td>
        </tr>
        <tr>

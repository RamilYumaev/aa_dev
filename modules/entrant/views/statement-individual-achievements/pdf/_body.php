...
<div class="mt-25">
    ...
    <p align="justify">Прошу рассмотреть предъявленные мной индивидуальные достижения и/или документ(ы),
        ...
        специалитета, программам магистратуры, утвержденного Приказом Министерства образования и науки РФ
        от 14.10.2015 № 1147, для начисления дополнительных баллов при приеме на обучение по программе(ам)
        <strong><?= DictCompetitiveGroupHelper::getEduLevelsGenitiveNameOne($statementIA->edu_level) ?></strong> в 2020
        году:</p>
    ...
    <?php if ($statementIA->edu_level == DictCompetitiveGroupHelper::EDUCATION_LEVEL_BACHELOR): ?>
        <p align="justify">
            ...
            программам магистратуры, утвержденного Приказом Министерства образования и науки РФ от 14.10.2015 № 1147
            ознакомлен(а).
        </p>
    <?php endif; ?>
    <p align="justify">

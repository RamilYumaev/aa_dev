...
if($department == AnketaHelper::HEAD_UNIVERSITY) {
    $this->params['breadcrumbs'][] = ['label' => 'Институты/факультеты (прием на целевое обучение)', 'url' => ['get-target-bachelor', 'department'=> $department ]];
}
        ...
        <div class="button-left">
            <?= $department == AnketaHelper::HEAD_UNIVERSITY ?
                Html::a(Html::tag("span", "", ["class" => "glyphicon glyphicon-arrow-left"]) . " Список факультетов",
                    ['get-target-bachelor', 'department'=> $department], ["class" => "btn btn-lg btn-warning position-fixed"]) : Html::a(Html::tag("span", "", ["class" => "glyphicon glyphicon-arrow-left"]) . " Уровни",

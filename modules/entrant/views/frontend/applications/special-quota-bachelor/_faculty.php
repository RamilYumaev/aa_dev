...
$this->title = "Институты/факультеты (Специальная квота в соответствии с Указом Президента РФ №268 от 09.05.2022 г.)";
...
//        ->all();
    ...
    if ($cgFaculty) {
        $result .= "<h3>" .Html::a(\dictionary\helpers\DictFacultyHelper::facultyList()[$faculty],['get-special-quota-bachelor', 'department'=> $department, 'faculty'=> $faculty]) . "</h3>";
    }
}
?>

...
$this->title = "Магистартура. Институты/факультеты (прием на целевое обучение)";
...
foreach ($currentFaculty as $faculty) {
    ...
    if ($cgFaculty) {
        $result .= "<h3>" .Html::a(\dictionary\helpers\DictFacultyHelper::facultyList()[$faculty],['get-target-magistracy', 'department'=> $department, 'faculty'=> $faculty]) . "</h3>";
    }
}
?>

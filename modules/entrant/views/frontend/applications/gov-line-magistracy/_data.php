...
$this->title = "Программы магистратуры для иностранных граждан поступающих по гослинии";

$this->params['breadcrumbs'][] = ['label' => 'Определение условий подачи документов', 'url' => ['/abiturient/anketa/step1']];
$this->params['breadcrumbs'][] = ['label' => 'Выбор уровня образования', 'url' => ['/abiturient/anketa/step2']];
if($department == AnketaHelper::HEAD_UNIVERSITY) {
    $this->params['breadcrumbs'][] = ['label' => 'Институты/факультеты', 'url' => ['get-gov-line-magistracy', 'department'=> $department ]];
}
        ...
        <div class="button-left">
            <?= $department == AnketaHelper::HEAD_UNIVERSITY ?
                Html::a(Html::tag("span", "", ["class" => "glyphicon glyphicon-arrow-left"]) . " Список факультетов",
                    ['get-gov-line-magistracy', 'department'=> $department], ["class" => "btn btn-lg btn-warning position-fixed"]) :

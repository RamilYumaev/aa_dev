...
<p>Договор подписывается в пункте 8 (под Вашими паспортными данными) и ниже, в соответствующем поле.
    Также, необходимо визировать каждую страницу договора (поставить подпись в правом нижнем углу).</p> </div>
            <div class="row">
                <div class="col-md-12">
                    <p class="text-center"><?=Html::a('ССЫЛКА НА ОБРАЗЕЦ ДОГОВОРА',
                            "@frontendInfo/documents/obrazec.pdf", ['target'=> "_blank"])?></p>
                </div>
            </div>
            <div class="text-danger fs-15">
                <p>В случае возникновения вопросов в рамках заключения договора об оказании платных образовательных услуг обращайтесь
                    в отдел договорного приема по тел. 8(495)438-18-57 или на многоканальный телефон Приемной комиссии МПГУ - 8(499)702-41-41. <br/>
                    Телефон приемной комиссии для поступающих в колледж МПГУ - 8(495) 372-59-26.</p>
            </div>

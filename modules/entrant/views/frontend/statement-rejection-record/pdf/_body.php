...
<div class="mt-200 fs-15">
    ...
    <p align="justify" class="lh-1-5">
        ...
        о зачислении в число студентов 1 курса по образовательной программе высшего образования – программе <?= DictCompetitiveGroupHelper::eduLevelGenitive()[$cg->edu_level] ?> –
        ...
        <?= $cg->specialty->codeWithName?><?= $cg->specialisationName ? ": ". $cg->specialisationName. "." : "."?>
    </p>

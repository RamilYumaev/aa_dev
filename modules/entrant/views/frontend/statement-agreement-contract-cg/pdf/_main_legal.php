...
<div width="100%" class="fs-11 agreement">
    ...
    <p align="justify" style="margin-top: 0 !important">
    ...
    <p align="justify">Обучающийся также вправе:</p>
    </p>
    ...
    <p align="justify">2.3.2. Пользоваться в порядке, установленном локальными нормативными актами Исполнителя,
        ...
        <p align="justify">2.3.3. Принимать в порядке, установленном локальными нормативными актами Исполнителя, участие в социально-культурных, оздоровительных и иных мероприятиях, организованных Исполнителем;</p>
    <p align="justify">2.3.4. Получать полную и достоверную информацию об оценке своих знаний, умений, навыков и компетенций, а также о критериях этой оценки;</p>
    <p align="justify">2.3.5. Пользоваться дополнительными образовательными услугами, не входящими в учебную программу, за отдельную плату.</p>
    <p align="justify">2.4. Исполнитель обязан:</p>
    <p align="justify">

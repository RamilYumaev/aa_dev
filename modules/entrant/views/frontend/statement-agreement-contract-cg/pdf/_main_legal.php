...
<div width="100%" class="fs-11 agreement" style="margin-top: 0">
    ...
    <p align="justify" style="margin: 0">
        ...
        а также в случае перевода и/или восстановления составляет <strong><?= $educationDuration ?></strong>< - год(а) (лет)
        (<strong><?= round($cg->education_duration * 2) ?></strong> - учебных семестра (-ов)).
    </p>
    <p align="justify" style="margin: 0">

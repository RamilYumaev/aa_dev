...
<p width="100%" class="fs-11 agreement" style="margin-top: 0">
    ...
    <p align="justify" style="margin-top: 0">
        ...
        и <strong><?= $legal->name ?></strong> именуемый(ая) в дальнейшем «Заказчик», в лице
        <strong><?= $legal->position ?> <?= $legal->fio ?></strong> действующего на основании
        <strong><?= $legal->footing ?><?= $legal->requisites ? " " . $legal->requisites : "" ?>,</strong><br/>
    ...
    <p align="justify" style="margin: 0">
        ...
        (<strong><?= round($cg->education_duration * 2) ?></strong> учебных семестров). <br />
        Срок обучения по индивидуальному учебному плану, в том числе ускоренному обучению, а также в
        случае перевода и/или восстановления составляет - год(а) (лет) (- учебных семестра (-ов)).
    </p>
    <p align="justify" style="margin: 0">
    ...
    <table width="100%" class="fs-11" cellspacing="0" style="margin-bottom: 0">
        <tr>
            <td class="text-center" width="30%"><strong>Университет</strong></td>
        ...
        <tr>
            ...
            <td class="bb pl-10" align="left" width="17%">Наименование организации</td>
            <td class="bb"
                align="left"><strong><u><?= $legal->name ?></u></strong></td>
        </tr>
        <tr>
            <td class="bb pl-10" align="left">паспорт:</td>
            <td class="bb br" align="left"><?= $passport['series'] . $passport['number'] ?></td>
            <td class="bb pl-10" align="left">ИНН/КПП:</td>
            <td class="bb" align="left"><?= $legal->inn ?></td>
        </tr>
        <tr>
            <td rowspan="2" class="bb pl-10" align="left">выдан:</td>
            <td rowspan="2" class="bb br" align="left"><?= $passport['authority'] ?>
        ...
        <tr>
            <td class="bb pl-10">к/c</td>
            <td class="bb"><?= $legal->k_c ?></td>
        </tr>
        <tr>
            <td rowspan="2" class="bb pl-10" align="left">телефон:</td>
            <td rowspan="2" class="bb br" align="left"><?= $profile['phone'] ?></td>
            <td class="bb pl-10">БИК</td>
            <td class="bb"><?= $legal->bik ?></td>
        </tr>
        <tr>

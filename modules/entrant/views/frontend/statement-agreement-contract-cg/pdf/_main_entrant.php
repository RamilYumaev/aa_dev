...
<p width="100%" class="fs-11 agreement" style="margin-top: 0">
    ...
    <p align="justify" style="margin-top: 0">
        ...
        «<strong>Московский педагогический государственный университет</strong>» (сокращенное наименование - МПГУ),
    ...
    <p align="justify" style="margin: 0">
        ...
        а также в случае перевода и/или восстановления составляет - год(а) (лет) (- учебных семестра (-ов)).
    </p>
    <p align="justify" style="margin: 0">
    ...
    <p align="justify" style="margin: 0">
        3.4. Копия платежного документа об оплате образовательных услуг за первый семестр для
    ...
    <p align="justify" style="margin: 0">
        ...
        один – для Университета, один – для Заказчика.
    </p>
    ...
    <table width="100%" class="fs-11" cellspacing="0" style="margin-bottom: 0">
        ...
        <tr>
            <td rowspan="7" class="br" align="left">
        ...
        <tr>
            <td class="bb h-30 pl-10" align="left">адрес электронной почты:</td>
            <td class="bb" align="left"><?= $profile['email']  ?></td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="text-left h-30 br" style="padding-top: 10px"><strong><?= $agreementData['positionNominative'] ?></strong></td>
        </tr>
        <tr>
            ...
            <td class="bb" style="padding-bottom: 0; margin-bottom: 0;  "></td>
            <td class="fs-25 bb" style="font-weight: 10px; padding-left: 50px;">/</td>
        </tr>
        <tr>
            <td>
                <table width="100%" style="border-spacing: 0px;">
                    <tr>
                        <td class="text-left pl-20" style=" padding-bottom: 0; padding-top: 0" >м.п.  Подпись</td>
                        <td class="text-right pr-20" style=" padding-bottom: 0; padding-top: 0"  >Ф.И.О.</td>
                    </tr>
                </table>
            </td>
            <td colspan="2">
                <table width="100%" style="border-spacing: 0px;">
                    <tr>
                        <td class="text-left " style=" padding-bottom: 0; padding-top: 0; padding-left: 60px; ">Подпись</td>
                        <td class="text-right " style="padding-bottom: 0; padding-top: 0; padding-right: 60px;">Ф.И.О.</td>
                    </tr>
                </table>
            </td>
    </table>

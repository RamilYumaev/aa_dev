...
?>
<div class="fs-15" style="margin-top: 150px">
...
справки по форме 086/у";
        ...
        <p>Подтверждаю, что у меня отсутствуют действительные (не отозванные) заявления о согласии на зачисление на обучение по программам высшего образования данного уровня на места в рамках контрольных цифр приема, в том числе, поданные в другие организации.</p>
    ...
    <p align="justify" class="lh-1-5">
        ...
        "предоставить в МПГУ оригинал документа об образовании $educationDocument$is086, удостоверяющего образование соответствующего уровня,

...
<div class="mt-25">
    ...
    <p align="justify">Прошу рассмотреть предъявленные мной индивидуальные достижения и/или документ(ы),
        подтверждающие наличие особых прав и/или преимуществ, указанных в пунктах 24, 25 и 27 Порядка приема
        ...
        <strong><?= DictCompetitiveGroupHelper::getEduLevelsGenitiveNameOne($statementIA->edu_level) ?></strong> в <?= date('Y')?>
        году:</p>

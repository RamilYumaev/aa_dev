...
<div class="container">
    <div class="row">
        <div class="col-md-12 mt-30">
            ...
            <?= \modules\superservice\widgets\ButtonChangeVersionDocumentsWidgets::widget(['category'=>json_encode([4]), 'document' => $model->type_document ?? '', 'version' => $model->version_document ?? '' ])?>

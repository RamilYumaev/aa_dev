...
<div class="row">
    <div class="col-md-12 <?= BlockRedGreenHelper::colorBg(AddressHelper::isExits($userId)) ?>">
        ...
        <h4>Адреса регистрации и проживания:</h4>
            <p> <span class="badge bg-red">В этом блоке необходимо обязательно указать фактический адрес Вашего
                    проживания и адрес регистрации (постоянной и/временной)</span></p>

...
namespace modules\support\controllers\frontend;

use modules\support\components\BackendFilter;
use modules\support\models\Content;
use modules\support\models\Ticket;
use modules\support\models\TicketSearch;
...
class DefaultController extends Controller
{
    ...
    {
        $this->view->title = \modules\support\ModuleFrontend::t('support', 'My Tickets');
    ...
    {
        $this->view->title = \modules\support\ModuleFrontend::t('support', 'Open Ticket');
        $model = new Ticket();
    ...
    public function actionClose($id)
    {
        ...
        if ($model->status != Ticket::STATUS_CLOSED) {
            ...
            $post->content = \modules\support\ModuleFrontend::t('support', '{USER} closed the ticket.',

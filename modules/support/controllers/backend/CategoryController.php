...
namespace modules\support\controllers\backend;

use modules\support\components\BackendFilter;
use modules\support\models\Category;
use modules\support\models\CategorySearch;
...
//                        },
    ...
    {
        $this->view->title = ModuleFrontend::t('support', 'Categories');
    ...
    public function actionView($id)
    {
        ...
        $this->view->title = \modules\support\ModuleFrontend::t('support', 'Category: {NAME}', ['NAME' => $model->title]);
    ...
    {
        $this->view->title = \modules\support\ModuleFrontend::t('support', 'Add Category');
        $model = new Category();
    ...
    {
        $model = $this->findModel($id);
        $this->view->title = \modules\support\ModuleFrontend::t('support', 'Update: {NAME}', ['NAME' => $model->title]);

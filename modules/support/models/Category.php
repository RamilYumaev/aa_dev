...
class Category extends CategoryBase
{
    ...
    {
        $option = [
            self::STATUS_ACTIVE => ModuleFrontend::t('support', 'Active'),
            self::STATUS_INACTIVE => ModuleFrontend::t('support', 'Inactive'),
        ];
        if (is_array($e)) {
            foreach ($e as $i) {
                unset($option[$i]);
    ...
    {
        return [
            'id' => ModuleFrontend::t('support', 'ID'),
            'title' => ModuleFrontend::t('support', 'Title'),
            'status' => ModuleFrontend::t('support', 'Status'),
            'created_at' => ModuleFrontend::t('support', 'Created At'),
            'updated_at' => ModuleFrontend::t('support', 'Updated At'),
        ];
    }

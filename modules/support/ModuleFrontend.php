 ...
 */
class ModuleFrontend extends \yii\base\Module
{
     ...
     * @inheritdoc
     */
    public $controllerNamespace = 'modules\support\controllers\frontend';
    ...
    public function registerTranslations()
    {
        Yii::$app->i18n->translations['modules/message/*'] = [
            ...
            'basePath'       => '@modules/support/messages',
            'fileMap'        => [
                'modules/message/support' => 'support.php',
            ],
        ];
    }
     ...
     */
    public static function t($category, $message, $params = [], $language = 'ru')
    {
        return Yii::t('modules/message/' . $category, $message, $params, $language);
    }

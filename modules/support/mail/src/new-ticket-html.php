...
<div itemscope itemtype="http://schema.org/EmailMessage">
    <div itemprop="potentialAction" itemscope itemtype="http://schema.org/ViewAction">
        ...
        <meta itemprop="name" content="<?= \modules\support\ModuleFrontend::t('support', 'View Ticket') ?>"/>
    </div>
    <meta itemprop="description"
          content="<?= \modules\support\ModuleFrontend::t('support', 'You\'ve received a ticket (#{ID}) from {APP}',
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td class="content-block">
                                        <?= \modules\support\ModuleFrontend::t('support', 'Greetings from {APP},',
                                            ['APP' => Yii::$app->name]) ?>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td class="content-block">
                                        <?= \modules\support\ModuleFrontend::t('support', 'Ticket #{ID}',
                                            ['ID' => $model->id]) ?>
                                        <br>
                                        <?= \modules\support\ModuleFrontend::t('support', 'Subject: {TITLE}',
                                            ['TITLE' => $model->title]) ?>
                                        <br>
                                ...
                                <tr>
                                    <td class="content-block aligncenter" colspan="2">
                                        <a href="<?= $model->getUrl(true) ?>"
                                           class="btn-primary"><?= \modules\support\ModuleFrontend::t('support',
                                                'View Ticket') ?></a>
                                    </td>
                                </tr>

...
$this->params['breadcrumbs'][] = [
    'label' => \modules\support\ModuleFrontend::t('support', 'Categories'),
    'url' => ['index']
];
...
<div class="category-view">
    <div class="box box-info">
        <div class="box-body">
            ...
            <p>
                <?= Html::a(\modules\support\ModuleFrontend::t('support', 'Update'),
                    ['update', 'id' => is_a($model, '\yii\mongodb\ActiveRecord') ? (string)$model->id : $model->id],
                    ['class' => 'btn btn-primary']) ?>
                <?= Html::a(\modules\support\ModuleFrontend::t('support', 'Delete'),
                    ['delete', 'id' => is_a($model, '\yii\mongodb\ActiveRecord') ? (string)$model->id : $model->id], [
                        'class' => 'btn btn-danger',
                        'data' => [
                            'confirm' => \modules\support\ModuleFrontend::t('support',

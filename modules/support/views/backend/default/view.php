...
/* @var $reply modules\support\models\Content */
    ...
    <div class="box box-info">
        <div class="box-header with-border">
            ...
            <div class="pull-right">
                <?= \modules\support\ModuleFrontend::t('support', 'Status: {STATUS}',
        ...
        <div class="box-body">
            ...
            <div style="padding-top: 10px">
                ...
                <div class="form-group">
                    <?= \yii\helpers\Html::submitButton(\modules\support\ModuleFrontend::t('support', 'Reply'),
                        ['class' => 'btn btn-primary']) ?>

                    <?php if ($model->status != Ticket::STATUS_CLOSED): ?>
                        <?= Html::a(\modules\support\ModuleFrontend::t('support', 'Close'), [
                            'close',
                            'id' => $model->hash_id

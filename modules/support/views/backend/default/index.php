...
/* @var $searchModel modules\support\models\TicketSearch */
...
<div class="ticket-index">
    <div class="box box-primary">
        <div class="box-header"> <h4><?= \modules\support\ModuleFrontend::t('support', 'Last tickets');?></h4></div>
        <div class="box-body">
                        ...
                        [
                            ...
                            'value' => function ($model) {
                                ...
                                if ($model->user && $module->urlViewUser) {
                                    return \yii\helpers\Html::a($model->user->profiles->fio,
                                    ...
                                    return $model->user->profiles->fio. " (ИД".$model->user_id." )";
                                }
                            },
                            'format' => 'raw'
                        ],

                            ...
                            <?php if($model->isContract() && $model->passExam->isSuccessExam()): ?>
                             <p class="bg-info">
                                 <?php if($model->transferMpgu->type == \modules\transfer\models\TransferMpgu::FROM_EDU): ?>
                                     ...
                                     Обращаем Ваше внимание! Заключить договор об оказании платных образовательных услуг можно только после предоставления документов об отчислении в Отдел переводов и восстановлений. Договор об оказании платных образовательных услуг заключается очно по адресу: Проспект Вернадского, 88, кабинет 546.
                                  ...
                                  <?php else: ?>
                                     «Вы успешно прошли аттестационные испытания и можете заключить договор об оказании платных образовательных услуг.<br/>
                                      Договор об оказании платных образовательных услуг заключается <u>очно</u> по адресу: Проспект Вернадского, 88, кабинет 548. Необходимо присутствие обучающегося и заказчика (в случае если обучающийся не является заказчиком).
                                      При себе необходимо иметь паспорта.
                                      При возникновении вопросов обращаться в отдел договорного приема МПГУ по тел: 8-499-233-41-81, по адресу электронной почты: otdel_vp@mpgu.su.»
                                 <?php endif; ?>
                             </p>

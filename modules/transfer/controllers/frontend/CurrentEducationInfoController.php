...
class CurrentEducationInfoController extends Controller
{
    ...
    public function getEnd() {
        return strtotime("2026-08-20 18:00:00") < strtotime(\date("Y-m-d G:i:s"));
    }

    public function getStartBudget() {
        return strtotime("2026-06-18 00:00:01") < strtotime(\date("Y-m-d G:i:s")) &&  strtotime("2026-07-15 18:00:00") >  strtotime(\date("Y-m-d G:i:s")) ;
    }

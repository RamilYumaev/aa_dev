...
class CurrentEducationInfoController extends Controller
{
    ...
    public function getEnd() {
        return strtotime("2026-02-05 18:00:00") < strtotime(\date("Y-m-d G:i:s"));
    }

    public function getStartBudget() {
        return strtotime("2025-12-18 00:00:01") < strtotime(\date("Y-m-d G:i:s")) &&  strtotime("2026-02-05 18:00:00") >  strtotime(\date("Y-m-d G:i:s")) ;
    }

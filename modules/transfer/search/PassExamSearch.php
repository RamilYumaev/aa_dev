...
{
    public $user_id,  $finance, $date_from, $edu_count,  $date_to, $is_pass, $agree, $success_exam, $faculty_id;
    protected $status;
    protected $protocol;
    ...
    {
        return [
            [['edu_count', 'user_id', 'is_pass', 'agree', 'finance', 'success_exam', 'faculty_id'], 'integer'],

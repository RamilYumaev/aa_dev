...
<?= $this->render("_header_obr", ['profile' => $profile, 'user_id' => $statementPd->user_id]) ?>
...
<div style="page-break-after: always;">
<?= $this->render("_header_ras", ['profile' => $profile, 'user_id' => $statementPd->user_id,]) ?>
...
<div style="page-break-after: always;">
<?= $this->render("_header_ras_rod", ['profile' => $profile, 'user_id' => $statementPd->user_id]) ?>
...
<?= $this->render("_header_obr_rod", ['profile' => $profile, 'user_id' => $statementPd->user_id]) ?>

...
class StatementAgreementContractTransferCg extends \yii\db\ActiveRecord
{
    ...
    public function getTextEmail() {
        if ($this->statusCreated()) {
            return 'Ваш договор об оказании платных образовательных услуг был сформирован сотрудником и прикреплен в Вашем личном кабинете. <br/>
            Вам необходимо ознакомиться с документом и прикрепить подписанный документ в Вашем личном кабинете.<br/>
            В случае обнаружения ошибок нажмите кнопку "Сообщить об ошибке" и опишите проблему';
        }
        if ($this->statusAccepted()) {
            return "Ваш договор об оказании платных образовательных услуг №".$this->number." ".mb_strtolower($this->statusName).". <br />
            В личном кабинете Вы можете скачать квитанцию для оплаты <br />
            Сумма и срок оплаты указаны в пункте 3 Вашего договора. Оплату можно произвести за год обучения или за семестр (половина годовой стоимости)
            ";
        }
        return "Ваш договор об оказании платных образовательных услуг ".mb_strtolower($this->statusName);
    }

    public function getSuccessTextEmail() {
        return "Ваш договор подписан со стороны Исполнителя (ВУЗа). <br />

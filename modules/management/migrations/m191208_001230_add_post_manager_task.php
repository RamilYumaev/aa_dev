...
class m191208_001230_add_post_manager_task extends Migration
{
    ...
    public function up()
    {
        ...
        $this->createIndex('{{%idx-management_task-post_management_id}}', $this->table(), 'post_management_id');
        $this->addForeignKey('{{%fk-idx-management_task-post_management_id}}', $this->table(),

    ...
    <div class="box box-warning">
        ...
        <div class="box-body">
            <div class="row">
                ...
                <div class="col-md-2"><?=  $comment->created_by == Yii::$app->user->identity->getId() ?
                        Html::a('<span class="fa fa-pencil-square-o"></span>',['comment-task/update',
                        'id' =>$comment->id,  'task_id' =>$comment->task_id], ['data-pjax' => 'w7', 'data-toggle' => 'modal', 'data-target' => '#modal', 'data-modalTitle' => 'Редактировать комментарий']): "" ?></div>
            </div>
        </div>
    </div>
<?php endforeach; ?>

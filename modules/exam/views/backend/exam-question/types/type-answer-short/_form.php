...
use modules\exam\assets\questions\QuestionAnswerShortAsset;
...
QuestionAnswerShortAsset::register($this);
?>
<div class="row">
    <div class="customer-form">
        <?php $form = ActiveForm::begin(['id' => 'dynamic-form']); ?>
        <div class="col-md-7">
            <?= $this->render('@modules/exam/views/backend/exam-question/_form-question', ['model' => $model->question, 'form' => $form, 'id'=> 'save-answer-short']) ?>
        </div>
        <div class="col-md-5">

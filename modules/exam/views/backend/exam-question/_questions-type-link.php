...
<div class="row">
    <div class="col-md-12">
        ...
        <?= Html::a('Трудный вопрос (на установление соответствия)', ['create', 'type' =>TestQuestionHelper::TYPE_MATCHING], [ 'class'=>'btn btn-success']); ?>
        <?= Html::a('Трудный вопрос (на установление последовательности)', ['create', 'type' =>TestQuestionHelper::TYPE_MATCHING], [ 'class'=>'btn btn-success']); ?>

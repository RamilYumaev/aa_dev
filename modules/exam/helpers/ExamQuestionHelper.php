...
class ExamQuestionHelper
{
    public static function listQuestions($ids) {
        return ExamQuestion::find()->select(['title','id'])
    ...
    {   $que = ExamQuestion::findOne($id);
        return $que? $que->type_id : null;
    }

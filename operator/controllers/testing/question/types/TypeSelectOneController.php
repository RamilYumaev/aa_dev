...
class TypeSelectOneController extends Controller
{
    ...
    public function actionCreate($olympic_id,$group_id = null)
    {
        ...
        return $this->render('@backend/views/testing/question/types/type-select-one/create', ['model' => $form]);
    }
    ...
    public function actionIndex($olympic_id)
    {
        ...
        return $this->render('@backend/views/testing/question/types/type-select-one/index', [
    ...
    public function actionUpdate($id,$olympic_id)
    {
        ...
        return $this->render('@backend/views/testing/question/types/type-select-one/update', ['model' => $form, 'question' => $model]);
    }

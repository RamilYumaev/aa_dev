...
class TypeAnswerDetailedController extends Controller
{
    ...
    public function actionCreate($olympic_id, $group_id = null)
    {
        ...
        return $this->render('@backend/views/testing/question/types/type-answer-detailed/create', ['model' => $form]);
    }
    ...
    public function actionIndex($olympic_id)
    {
        ...
        return $this->render('@backend/views/testing/question/types/type-answer-detailed/index', [
    ...
    public function actionUpdate($id, $olympic_id)
    {
        ...
        return $this->render('@backend/views/testing/question/types/type-answer-detailed/update', ['model' => $form, 'question' => $model]);
    }

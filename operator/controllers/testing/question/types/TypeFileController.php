...
class TypeFileController extends Controller
{
    ...
    public function actionIndex($olympic_id)
    {
        ...
        return $this->render('@backend/views/testing/question/types/type-file/index', [
    ...
    public function actionCreate($olympic_id,$group_id = null)
    {
        ...
        return $this->render('@backend/views/testing/question/types/type-file/create', ['model' => $form]);
    }
    ...
    public function actionUpdate($id, $olympic_id)
    {
        ...
        return $this->render('@backend/views/testing/question/types/type-file/update', ['model' => $form, 'question' => $model]);
    }

...
{
    private $type = TestQuestionHelper::TYPE_SELECT;
    ...
    public function actionCreate($olympic_id, $group_id = null)
    {
        ...
        return $this->render('@backend/views/testing/question/types/type-select/create', ['model' => $form]);
    }
    ...
    public function actionUpdate($id, $olympic_id)
    {
        ...
        return $this->render('@backend/views/testing/question/types/type-select/update', ['model' => $form, 'question' => $model]);
    }
    ...
    public function actionIndex($olympic_id)
    {
        ...
        return $this->render('@backend/views/testing/question/types/type-select/index', [

...
use helpers\DictChairmansHelper;
    ...
    public function rules()
    {
        return [
            [['name', 'chairman_id', 'number_of_tours', 'edu_level_olymp', 'date_time_start_reg',
                'date_time_finish_reg', 'genitive_name', 'faculty_id'],
                'required', 'when' => function ($model) {
                return $model->prefilling == 0;
            }, 'whenClient' => 'function(attribute, value){
                    return $("#olympiceditform-prefilling").val ==0}'],

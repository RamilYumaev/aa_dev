...
class OlympicForm extends Model
{
    public $name,
        $chairman_id,
        $number_of_tours,
    ...
    public function __construct(Olympic $olympic = null, $config = [])
    {
        if ($olympic) {
            ...
            $this->competitiveGroupsList = $olympic->competitiveGroupsList;
            $this->classesList = $olympic->classesList;
    ...
    public function rules()
    {
        return [
            ...
            return $("#olimpic-edu_level_olymp").val() == 1 
            || $("#olimpic-edu_level_olymp").val() == 2}'],
